...
from info import CHANNELS, MV_UPDATE_CHANNEL, LOG_CHANNEL, ADMINS, SEND_MV_LOGS
...
async def media_handler(bot, message):
    ...
    if SEND_MV_LOGS:
        ...
        if base_filename not in logged_files:
            ...
            button2 = InlineKeyboardButton('Rᴇǫᴜᴇsᴛ Gʀᴏᴜᴘ ♂️', url=GRP_LNK)
