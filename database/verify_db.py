###============================================================###
## Rx Bot — Verification Analytics Database (async motor)
## Cinewood का sync MongoClient version async motor में rewrite (sync bug fix)
###============================================================###
...
class VR_db:
    ...
    async def save_verification(self, user_id):
        ...
        await self.collection.insert_one(
            {"user_id": user_id, "verified_at": now, "year": now.year}
        )
